...
class Page{
	...
	public function __destruct(){
		unset($this->_title, $this->_main_navigation, $this->_login_navigation, $this->_content);
	}
	
	public function get_title(){ return $this->_title; }
	public function get_main_navigation(){ return $this->_main_navigation; }
	public function get_login_navigation(){ return $this->_login_navigation; }
	...
	public function set_login_navigation($login_navigation){ $this->_login_navigation = $login_navigation; }
